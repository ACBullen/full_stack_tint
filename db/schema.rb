...
ActiveRecord::Schema.define(version: 20170526174108) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "profile_pic",     default: "http://res.cloudinary.com/dadyuehpo/image/upload/v1495820397/letter-t37_mozgvd.jpg", null: false
