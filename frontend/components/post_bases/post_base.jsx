...
class PostBase extends React.Component {
  ...
  render(){
    ...
    switch (post.post_type) {
      case "quote":
        return <QuotePost post={post} user={user} fi={fi}  />
      case "image":

        return <ImagePost post={post} user={user} fi={fi} />
      case "link":
        return <LinkPost post={post} user={user} fi={fi} />
      case "video":
        return <VideoPost post={post} user={user} fi={fi} />
      case "audio":
        return <AudioPost post={post} user={user} fi={fi} />
      case "text":
        return <TextPost post={post} user={user} fi={fi} />
      default:
      return(
